...
<div class="card mt-5" data-aos="zoom-in">
    <div class="bg-primary py-3">
        <h2 class="text-white text-center"><i class="fas fa-box-open me-2"></i> Ingresar Nuevo Producto</h2>
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('products.store') }}" method="POST" data-aos="fade-right">
            @csrf
            @method('POST')
